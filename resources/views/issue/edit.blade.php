...
<div class="container">
    <div class="row">
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/issue/'.$issue->id) }}">
                    {{ csrf_field() }}
                        ...
                        <div class="panel-body">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="no" type="text" class="form-control" name="no" value="{{ $issue->no }}" readonly required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="part_no" class="col-md-4 control-label">Unit Code</label>
                                    <div class="col-md-6">
                                        <input id="unit_text" type="text" class="form-control" value="{{ $issue->unit->code }}" required>
                                        <input id="unit_id" type="text" name="unit_id" value="{{ $issue->unit_id }}" required hidden>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="sn" name="sn" value="{{ $issue->sn }}" type="text" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="part_no" class="col-md-4 control-label">H/M</label>
                                    <div class="col-md-6">
                                        <input id="hm" name="hm" value="{{ $issue->hm }}" type="text" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="created_at" type="text" class="form-control" value="{{ $issue->created_at }}" name="created_at" required>
                                    </div>
                                    <script type="text/javascript">
                                        $(function () {
                        ...
                        <div class="panel-body">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="diketahui" type="text" class="form-control" value="{{ $issue->diketahui }}" name="diketahui" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="diterima" type="text" class="form-control" value="{{ $issue->diterima }}" name="diterima" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="diserahkan" type="text" class="form-control" value="{{ $issue->diserahkan }}" name="diserahkan" required>
                                    </div>
                                </div>
                            </div>
                        </div>
