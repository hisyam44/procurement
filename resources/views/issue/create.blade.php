                    ...
                    <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input id="part_name" type="text" class="form-control" placeholder="Item Name.." name="name[]" required>
                                </div>
                                <div class="col-md-1">
                                    <input id="qty" type="text" class="form-control" placeholder="QTY.." name="qty[]" required>
                                </div>
                                <div class="col-md-1">
                                    <input id="btl" type="text" class="form-control" placeholder="UOM.." required readonly>
                                </div>
                                <div class="col-md-4">
                                    <input id="keterangan[]" type="text" class="form-control description" placeholder="Description.." name="keterangan[]" required>
                                </div>
                                <div class="col-md-1">
