                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/material') }}">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="part_no" class="col-md-4 control-label">No. PO</label>
                                    <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="part_no" class="col-md-4 control-label">Delivery Man</label>
                                    <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="panel-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="part_no" class="col-md-4 control-label">Mengetahui</label>
                                    <div class="col-md-6">
