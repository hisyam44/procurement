...
<div class="container">
    <div class="row">
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/material/'.$material->id) }}">
                    {{ csrf_field() }}
                        ...
                        <div class="panel-body">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="order_text" type="text" class="form-control" value="{{ $material->order->no }}" readonly required>
                                        <input id="order_id" type="text" name="order_id" value="{{ $material->order_id }}" required hidden>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="part_no" class="col-md-4 control-label">Supplier</label>
                                    <div class="col-md-6">
                                        <input id="supplier" type="text" value="{{ $material->order->supplier->name }}" class="form-control" required readonly>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="unit_text" type="text" class="form-control" value="{{ $material->unit->code }}" readonly required>
                    ...
                    <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="col-md-2">
                                    <input type="text" onfocus="autoComplete(this)" class="form-control" placeholder="Part No.." value="{{ $item->partno->code }}" readonly>
                                    <input id="" type="text" class="item_code" value="{{ $item->partno_id }}" placeholder="Item Code.." name="partno_id[]" hidden required>
                                </div>
                                <div class="col-md-3">
                                    <input id="part_name" type="text" class="form-control" value="{{ $item->part_name }}" placeholder="Part Name.." name="part_name[]" required>
                                </div>
                                <div class="col-md-1">
                                    <input id="qty" type="text" class="form-control" placeholder="QTY.." value="{{ $item->qty }}" name="qty[]" required>
                                </div>
                                <div class="col-md-1">
                                    <input id="btl" type="text" class="form-control" value="{{ $item->partno->item->uom }}" placeholder="BTL.." required readonly>
                                </div>
                                <div class="col-md-1">
                                    <input id="net" type="text" class="form-control" value="{{ $item->net }}" placeholder="NET.." name="net[]" required>
                                </div>
                                <div class="col-md-3">
                                    <input id="description[]" type="text" class="form-control description" value="{{ $item->description }}" placeholder="Description.." name="description[]" required>
                                </div>
                                <div class="col-md-1">
                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="diketahui" type="text" class="form-control" value="{{ $material->diketahui }}" name="diketahui" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="diterima" type="text" class="form-control" value="{{ $material->diterima }}" name="diterima" required>
                                    </div>
                                </div>
                            </div>
                        </div>
